 ...
 * {@link DetallesPersonajes.OnFragmentInteractionListener} interface
 * to handle interaction events.
 * Use the {@link DetallesPersonajes#newInstance} factory method to
...
public class DetallesPersonajes extends Fragment {
     ...
     * @return A new instance of fragment DetallesPersonajes.
     */
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
       ...
       View vista=inflater.inflate(R.layout.fragment_detalles_personajes, container, false);
        textoDescripcion= (TextView) vista.findViewById(R.id.descripcionId);
        imagenDetalle= (ImageView) vista.findViewById(R.id.imagenDetalleId);

        Bundle objetoPersonaje=getArguments();
        PersonajesVo personaje=null;

        if(objetoPersonaje!=null){
            personaje=(PersonajesVo) objetoPersonaje.getSerializable("objeto");
            imagenDetalle.setImageResource(personaje.getImagenDetalle());
            textoDescripcion.setText(personaje.getDescripcion());
